 ...
 */
bool loadConfig(String config_file, String& wifi_ssid, String& wifi_password, String& ftp_server, String& ftp_username, String& ftp_password, int& court_id) {
  ...
  court_id = doc["identity"]["cid"].as<int>();
